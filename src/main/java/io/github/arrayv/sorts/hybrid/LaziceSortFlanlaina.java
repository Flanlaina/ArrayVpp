...
public final class LaziceSortFlanlaina extends Sort {

    public LaziceSortFlanlaina(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Lazice Stable (Flanlaina)");
        this.setRunAllSortsName("Flanlaina's Lazice Stable Sort");
        this.setRunSortName("Flanlaina's Lazice Sort");
        this.setCategory("Hybrid Sorts");
        this.setAuthors("Distray, Flanlaina");
