...
/**
 * A Median-of-Medians Stable Quicksort with changeable external space.
 * <p>
 * To use this algorithm in another, use {@link #quickSort(int[], int, int, int)} from a reference instance.
 * 
