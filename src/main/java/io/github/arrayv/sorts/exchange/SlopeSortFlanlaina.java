 ...
 *
 */
public class SlopeSortFlanlaina extends Sort {

    public SlopeSortFlanlaina(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        setSortListName("Slope (Flanlaina's update)");
        setRunAllSortsName("Slope Sort");
        setRunSortName("Slopesort");
        setCategory("Exchange Sorts");
        setAuthors("EilrahcF, Flanlaina");
        setBucketSort(false);
        setRadixSort(false);
